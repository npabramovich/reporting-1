    ...
    <div className="p-4 md:p-8">
      ...
      <div className="flex gap-16">
        ...
        <div id="company-detail" className="pl-4 border-l-2 border-border">
          ...
          <p className="text-muted-foreground">
            The company page can be extended to store investment and ownership details, cap table
            information, and valuation analysis, and to generate tearsheets (company one-page
            summaries).{' '}
            <a
              href="https://www.hemrock.com"
              target="_blank"
        ...
        <div id="notes">
          ...
          <p className="text-muted-foreground mb-2">
            Notes are available in two places: on each company&apos;s detail page, and on the Portfolio
            dashboard. They provide a lightweight way for team members to share observations, context,
            and follow-up items without leaving the platform.
          </p>
          <p className="text-muted-foreground mb-2">
